...
bool createAnnouncement(int courseId, string courseTitle, string message, string postedBy);
...
bool isCourseApproved(int courseId);
bool isAlreadyEnrolled(string studentEmail, int courseId);
bool removeEnrollment(string studentEmail, int courseId);
void removeUnapprovedEnrollmentsForStudent(string studentEmail);
};
